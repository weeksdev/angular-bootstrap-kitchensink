angular.module('app').component('tableWithModal', {
    templateUrl: 'app/template/componentTypes/tableWithModal/tableWithModal.html',
    controller: function (modalCodeFactory) {
        ...
        ctrl.showCode = function () {
            modalCodeFactory.showCode('tableWithModal');
        };
    }
})
.component('tableWithModalModalDialog', {
    templateUrl: 'app/template/componentTypes/tableWithModal/tableWithModalModalDialog.html',
    bindings:{
        record: '='
    },
    controller: function(){
