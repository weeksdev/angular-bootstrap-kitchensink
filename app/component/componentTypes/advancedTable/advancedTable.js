angular.module('app').component('advancedTable',{
    templateUrl: 'app/template/componentTypes/advancedTable/advancedTable.html',
    controller: function(modalCodeFactory){
       ...
       ctrl.showCode = function(){
           modalCodeFactory.showCode('advancedTable');
       }
    }
})