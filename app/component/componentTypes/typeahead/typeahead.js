angular.module('app').component('typeahead', {
    templateUrl: 'app/template/componentTypes/typeahead/typeahead.html',
    controller: function ($filter, modalCodeFactory) {
        var ctrl = this;
        ctrl.records = [{
            firstName: 'John',
            lastName: 'Lennon',
        ...
        ctrl.showCode = function () {
            modalCodeFactory.showCode('typeahead');
        }
    }
})